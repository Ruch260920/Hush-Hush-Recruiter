...
df1 = pd.read_csv('/Users/ruchiravindramanjalkar/Desktop/bdp-oct23-exam-bdp_oct23_group13/code/0to50k_profile_data.csv')
print('df1 :',df1.shape)
df2 = pd.read_csv('/Users/ruchiravindramanjalkar/Desktop/bdp-oct23-exam-bdp_oct23_group13/code/50to100k_profile_data.csv')
print('df2 :',df2.shape)
df3 = pd.read_csv('/Users/ruchiravindramanjalkar/Desktop/bdp-oct23-exam-bdp_oct23_group13/code/0to50k_activity_data.csv')
print('df3 :',df3.shape)
df4 = pd.read_csv('/Users/ruchiravindramanjalkar/Desktop/bdp-oct23-exam-bdp_oct23_group13/code/50to100k_activity_data.csv')
print('df4 :',df4.shape)
